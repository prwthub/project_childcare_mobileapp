...
app.post('/location/getStudentStatus', getStudentStatus);                                                       // ✅   get student status by ( schoolName, carNumber, studentId )
// * นำไปดึงสถานะของนักเรียน โดยระบุ id ของนักเรียน
