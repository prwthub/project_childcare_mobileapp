...
class ParentPersonalProfileWidget extends StatefulWidget {
  const ParentPersonalProfileWidget({super.key});

  @override
  State<ParentPersonalProfileWidget> createState() =>
      _ParentPersonalProfileWidgetState();
}

class _ParentPersonalProfileWidgetState
    extends State<ParentPersonalProfileWidget> {
  late ParentPersonalProfileModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ParentPersonalProfileModel());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<SchoolRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<SchoolRecord> parentPersonalProfileSchoolRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final parentPersonalProfileSchoolRecord =
            parentPersonalProfileSchoolRecordList.isNotEmpty
                ? parentPersonalProfileSchoolRecordList.first
                : null;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).primaryBackground,
