...
import 'driver_map_model.dart';
export 'driver_map_model.dart';
...
class _DriverMapWidgetState extends State<DriverMapWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DriverMapModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<CarRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CarRecord> driverMapCarRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final driverMapCarRecord = driverMapCarRecordList.isNotEmpty
            ? driverMapCarRecordList.first
            : null;
